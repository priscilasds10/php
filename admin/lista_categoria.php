...
<body>
    ...
    ?>
    <tr bgcolor="#fff">
            <td><font size="2" face="verdana,arial"><?php echo $linha ['id_categoria']?></font></td>
            <td><font size="2" face="verdana,arial"><?php echo $linha ['categoria']?></font></td>
            <td><font size="2" face="verdana,arial"><?php echo $linha ['cat_ativo']?></font></td>
